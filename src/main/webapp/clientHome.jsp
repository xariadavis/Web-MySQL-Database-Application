...
<p id="user-type-p">You are connected to the Project 3 Enterprise Systems database as a <mark class="user-type">client-level</mark> user.</p>
<p>Please enter any valid SQL query or update command in the box below</p>

<form method="post" id="SQLForm" action="ClientUserApp">
    <div id="command-div">
